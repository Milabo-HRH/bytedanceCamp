...
public class UploadActivity extends AppCompatActivity {
    ...
    private void submit() {
        ...
        MultipartBody.Part p_to   = MultipartBody.Part.createFormData("to", to);
        MultipartBody.Part p_content = MultipartBody.Part.createFormData("content", content);
        ...
        Call<UploadResponse> call = api.submitMessage(Constants.STUDENT_ID, "", from, p_to, p_content, image, Constants.token);
