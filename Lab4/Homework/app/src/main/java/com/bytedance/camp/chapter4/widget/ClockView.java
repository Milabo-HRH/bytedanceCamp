...
public class ClockView extends View {
    ...
    private void drawTimeNeedles(Canvas canvas) {
         ...
         */
         int hourDegree = (hour*30+(int)(minute*0.5)+270)%360;
         int minDegree = (minute*6+(int)(second*0.1)+270)%360;
         int secondDegree = (second*6+270)%360;
         ...
         RectF h = new RectF(centerX,centerY,endX,endY);
         unitPaint.setStrokeWidth(HOUR_NEEDLE_WIDTH);
         canvas.drawLine(h.left, h.top, h.right, h.bottom, unitPaint);
         ...
         unitPaint.setStrokeWidth(MINUTE_NEEDLE_WIDTH);
         h = new RectF(centerX,centerY,endX,endY);
         canvas.drawLine(h.left, h.top, h.right, h.bottom, unitPaint);
        ...
        h = new RectF(centerX,centerY,endX,endY);
        unitPaint.setStrokeWidth(SECOND_NEEDLE_WIDTH);
        canvas.drawLine(h.left, h.top, h.right, h.bottom, unitPaint);
    }
