...
public class Ch3Ex2Activity extends AppCompatActivity {
    ...
    private void resetTargetAnimation() {
        ...
        ObjectAnimator sizeXAnimator = ObjectAnimator.ofFloat(target, "scaleX",1f, 2f);
        sizeXAnimator.setRepeatCount(ValueAnimator.INFINITE);
        sizeXAnimator.setDuration(1000);
        sizeXAnimator.setRepeatMode(ValueAnimator.REVERSE);
        sizeXAnimator.setInterpolator(new LinearInterpolator());
        ObjectAnimator sizeYAnimator = ObjectAnimator.ofFloat(target, "ScaleY", 1f, 2f);
        sizeYAnimator.setRepeatCount(ValueAnimator.INFINITE);
        sizeYAnimator.setDuration(1000);
        sizeYAnimator.setRepeatMode(ValueAnimator.REVERSE);
        sizeYAnimator.setInterpolator(new LinearInterpolator());
        ...
        animatorSet.playTogether(animator1, sizeXAnimator, sizeYAnimator, alphaAnimator);
        animatorSet.start();
    }
}
